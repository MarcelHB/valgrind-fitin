...
#ifdef DUP
template <typename T>
using fsProtect = sihft::dup<T>;
#elif TRI
template <typename T>
using fsProtect = sihft::tri<T>;
#elif TRUMP
template <typename T>
using fsProtect = sihft::trump<T>;
#endif

#if defined(DUP) || defined(TRI) || defined(TRUMP)
typedef fsProtect<int> Int;
typedef fsProtect<unsigned int> UInt;
typedef fsProtect<short> Short;
typedef fsProtect<unsigned short> UShort;
typedef fsProtect<long> Long;
typedef fsProtect<unsigned long> ULong;
typedef fsProtect<long long> LongLong;
typedef fsProtect<unsigned long long> ULongLong;
...
#if defined(BCBOOL) || defined(CSBOOL) || defined(EPBOOL) || defined(RMBOOL) || defined(SHBOOL)

#if defined(BCBOOL)
#include "flipsafe/include/data/bcbool.hh"
typedef bcbool<> Boolean;
#elif defined(CSBOOL)
#include "flipsafe/include/data/csbool.hh"
typedef csbool<> Boolean;
#elif defined(EPBOOL)
#include "flipsafe/include/data/epbool.hh"
typedef epbool<> Boolean;
#elif defined(RMBOOL)
#include "flipsafe/include/data/rmbool.hh"
typedef rmbool<> Boolean;
#elif defined(SHBOOL)
#include "flipsafe/include/data/shbool.hh"
typedef shbool<> Boolean;
#endif

#define FITIN_MONITOR_BOOL(var) FITIN_MONITOR_VARIABLE(var.i)
#define FITIN_UNMONITOR_BOOL(var) FITIN_UNMONITOR_VARIABLE(var.i)

#else
typedef Int     Boolean;
#define FITIN_MONITOR_BOOL(var) FITIN_MONITOR_VARIABLE(var)
#define FITIN_UNMONITOR_BOOL(var) FITIN_UNMONITOR_VARIABLE(var)
#endif
